...
See the [project requirements](/dev-docs/get-started/requirements) page to get started.
...
Any hosted Redis database that meets the [project requirements](/dev-docs/get-started/requirements) work for this purpose. Follow the deployment documentation of your choice to get up your Redis cache.
